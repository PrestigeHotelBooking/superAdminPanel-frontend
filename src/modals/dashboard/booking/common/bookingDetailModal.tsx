          ...
          <div className='w-full'>
            ...
            <div className='flex space-x-2 mt-3 p-4 '>
              <div className='flex-1'>
                ...
                <div>
                  <DateFormat date={dataMemo?.booking_date as string} formatType={'dd MMM yyyy'}></DateFormat>
                </div>
              </div>
              <div className='flex-1'>
                <div className='font-semibold'>Check-IN</div>
                <div>
                  <DateFormat date={dataMemo?.check_in as string} formatType={'dd MMM yyyy'}></DateFormat>
                </div>
              </div>
              <div className='flex-1'>
                <div className='font-semibold'>Check-Out</div>
                <div>
                  <DateFormat date={dataMemo?.check_out as string} formatType={'dd MMM yyyy'}></DateFormat>
                </div>
              </div>
              <div className='flex-1'>
                ...
                <div>
                  <BookingComponentStatusColor
                    data={dataMemo?.booking_status as bookingStatusT}
                  ></BookingComponentStatusColor>
                </div>
              </div>
              <div className='flex-1'>
                ...
                <div>
                  <CheckInStatusComponentColor
                    data={dataMemo?.check_in_status as checkInStatusT}
                  ></CheckInStatusComponentColor>
                </div>
              </div>
            </div>
            ...
            <div className='flex space-x-2  p-3'>
              ...
              <div className='flex-1'>
                ...
                <div>
                  <ComissionCellComponentColor data={dataMemo?.commission}></ComissionCellComponentColor>
                </div>
              </div>
              <div className='flex-1'>
                <PrLabel text={'Payment Status'}></PrLabel>
                <div>
                  <PaymentStatusCellComponentColor
                    data={dataMemo?.payment_status as PaymentStatusT}
                  ></PaymentStatusCellComponentColor>
                </div>
              </div>
            </div>
