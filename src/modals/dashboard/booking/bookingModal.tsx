...
function BookingModal() {
   ...
   const BookingActionComponent: React.FC<TableCellPropsT> = (props) => {
      ...
      return (
         <div>
            <PrIcon name={'Eye'} className="cursor-pointer" color='blue' onClick={() => handleModal(props.rowData.booking_id)} ></PrIcon>
         </div>
      );
   }
   ...
   return (
      <div>
         ...
         <div className="ml-auto flex items-center space-x-4">
            ...
            }} value={''} prSelectOption={[]} prSelectValue={""} prOnChange={function (value: string): void {
               throw new Error("Function not implemented.");
