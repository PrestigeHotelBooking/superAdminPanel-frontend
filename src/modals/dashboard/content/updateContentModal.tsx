            ...
            <div className="bg-white w-[40%] p-8 rounded-lg shadow-lg">
                ...
                <div className={`w-full h-[15rem] border-dotted border-2 border-gray-300 rounded-lg mr-4 mb-4`}>
                    ...
                    {(addContentModalData?.contentImage) ? (
                        ...
                        <PrButton buttonStyle='danger' onClick={()=>{ handleState({ contentImage:'' }) } }  className="rounded-md" label={"Reset Image"}/>
                        </div>
                    ) : (
                ...
                <div className="flex justify-center">
                    <PrButtonV2 label={addLoading ? 'Adding' : 'Add'} loading={addLoading} buttonStyle='danger' className="rounded-md " onClick={updateToDatabase}></PrButtonV2>
                </div>
            </div>
        </div>
    );
