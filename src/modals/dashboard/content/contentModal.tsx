    ...
    const filter: FilterCriteria[] = [
      {
        ...
        operator: 'BETWEEN',
        value: {
          startDate: contentData?.datePicker?.calendarStartDate,
          endDate: contentData?.datePicker?.calendarEndDate,
        },
      },
    ];
    const filterdData = await BackendPost(`${ENDPOINTS.CONTENT.GET}`, { filter });
