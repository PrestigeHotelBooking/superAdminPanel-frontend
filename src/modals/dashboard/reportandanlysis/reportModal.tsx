...
import {
  ...
  PropertyCellComponent,
} from './common/reportTableComponents';
    ...
    <div>
      <div className='h-[4rem] flex'>
        ...
        <div className='ml-auto flex items-center space-x-4'>
          <DateFilter
            onDateRangeChange={function (startDate: Date | null, endDate: Date | null): void {
      ...
      <RevenueTabs selectedTab={selectedTab} onTabChange={handleTabChange}></RevenueTabs>
      {selectedTab === 'BOOKING' ? (
        <PrTable
          headers={[
            {
        ...
        <PrTable
          headers={[
            { name: '#', id: 'index', renderComponent: IndexCellComponent, renderProps: { dataField: 'index' } },
            {
              name: 'Property Name',
              id: 'propertyName',
            ...
            {
              name: 'No Of Successfull Bookings',
              id: 'totalNumber',
