          ...
          <form className='flex'>
            <div>
              <PRInputField
                ...
                onChange={(e: any) => handleState({ propertyName: e.target.value })}
              />
              <div className='text-bg-[#061D30] font-bold text-[1rem] mb-4'>Property Address</div>
              <PrInputFieldV2
                label={'Address Line 1'}
                value={addPropertyData.addressLine1}
                onChange={(e: any) => handleState({ addressLine1: e.target.value })}
              ></PrInputFieldV2>
              <PrInputFieldV2
                label={'Address Line 2'}
                value={addPropertyData.addressLine2}
                onChange={(e: any) => handleState({ addressLine2: e.target.value })}
              ></PrInputFieldV2>
              <PrInputFieldV2
                label={'City/Town'}
            ...
            <div className='ml-12'>
              ...
              <PRInputField
                ...
                onChange={(e: any) => handleState({ totalNoOfRooms: e.target.value })}
