    ...
    <div className="flex flex-col w-full shadow-md rounded-lg bg-blue-600">
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left text-black dark:text-gray-100 table-fixed">
          <colgroup>
            <col className="w-8" />{" "}
            {/* Set a fixed width for the "index" column */}
          ...
          <table className="w-full h-full bg-white">
            <tbody>
              <tr>
                <td>
                  <NoDataFound />
              {refreshButton &&   <PrButtonV2 label={"Try Again"} onClick={refreshButton}  className=" rounded-full mx-auto mb-8"/>}
                </td>
              </tr>
              <tr >
    </tr>
