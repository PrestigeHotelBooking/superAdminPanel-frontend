  ...
  return (
    <div className='w-full h-[7rem] bg-white flex relative'>
      ...
      >
        ...
        <div className='ml-2'>
          <label className='text-black font-semibold text-[18px] p-1 mt-2'>Username</label>
          <br />
              ...
              <Box className='w-48 mt-2'>
                <Paper elevation={6}>
                  <ul className='py-2'>
                    ...
                    <li
                      className='px-4 py-2 cursor-pointer hover:bg-blue-100 flex flex-row space-x-2'
