...
export default function Errorpage() {
  ...
  return (
    <div className='flex flex-col space-y-8 justify-center items-center h-screen bg-gray-100'>
      ...
      <div className='text-blue-500 font-bold text-[1.5rem] italic flex flex-row space-x-4'>
        You can return to the{' '}
        <div className='ml-3 underline cursor-pointer text-blue-800' onClick={pageRedirect}>
          {' '}
          home page.
        </div>
      </div>
